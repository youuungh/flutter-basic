...
import 'package:flutter_daangn/screen/post_detail_stateful/state/product_post_state.dart';
import 'package:flutter_hooks/flutter_hooks.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

import '../../entity/product/vo_product.dart';
import '../post_detail_riverpod/w_post_content.dart';
import '../post_detail_riverpod/w_user_profile.dart';

abstract interface class PostIdProvidedScreen implements StatefulWidget {
  int get id;
}

class PostDetailScreenWithStatefulWidget extends ConsumerStatefulWidget implements PostIdProvidedScreen {
  final SimpleProductPost? simpleProductPost;
  @override
  final int id;

  const PostDetailScreenWithStatefulWidget(this.id,
      {super.key, this.simpleProductPost});
