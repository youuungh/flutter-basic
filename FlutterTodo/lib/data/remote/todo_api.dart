...
import 'package:flutter_todo/data/remote/clients/todo_client.dart';
import 'package:flutter_todo/data/remote/result/api_error.dart';
...
class TodoApi implements TodoRepository<ApiError> {
  ...
  Future<SimpleResult<T, ApiError>> tryRequest<T>(
    ...
    try {
      ...
      return SimpleResult.failure(ApiError.createErrorResult(e).failureData);
    }
  }
}
